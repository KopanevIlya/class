                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    ...
                    >
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                11111Laravel has wonderful documentation covering every aspect of the framework. Whether
                                you
                    ...
                    >
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                               11111 Laravel News is a community driven portal and newsletter aggregating all of the
                                latest
                    ...
                    >
                        <div>
                            ...
                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">1233Vibrant
                                Ecosystem</h2>
